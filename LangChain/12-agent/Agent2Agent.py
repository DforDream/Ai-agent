...
def create_travel_coordinator_agent(llm, ctrip_chain, meituan_chain, didi_chain):
    ...
    def a2a_schedule(input_dict):
        ...
        try: 
            ctrip_result = ctrip_chain.invoke({"input": "北京到上海订机票2026-02-01"})
        except:
            ctrip_result = ""
        ...
        try:
            meituan_result = meituan_chain.invoke({"input": "上海浦东机场订酒店2026-02-01到2026-02-02"})
        except:
            meituan_result = ""
        ...
        try:
            didi_result = didi_chain.invoke({"input": "上海浦东机场T2到上海浦东机场铂尔曼大酒店预约打车2026-02-01 16:40"})
        except:
            didi_result = ""
